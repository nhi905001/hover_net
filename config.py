...
class Config(object):
    ...
    def __init__(self):
        ...
        nr_type = 1  # number of nuclear types (including background)
        ...
        self.log_dir = "checkpoints/"  # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = ["dataset/training_data/kumar/train/540x540_164x164/"]
        self.valid_dir_list = ["dataset/training_data/kumar/valid/540x540_164x164/"]
